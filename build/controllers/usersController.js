    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                Users = _a.sent();
                if (!Users)
                    return [2 /*return*/, res.status(204).json({ "message": "No Users found" })];
        ...
        switch (_b.label) {
            case 0:
                ...
                if (!((_a = req === null || req === void 0 ? void 0 : req.params) === null || _a === void 0 ? void 0 : _a.username))
                    return [2 /*return*/, res.status(400).json({ "message": "Username required" })];
                username = req.params.username;
                return [4 /*yield*/, User.findOne({ username: username }).exec()];
            case 1:
                user = _b.sent();
                if (!user) {
                    return [2 /*return*/, res.status(204).json({ "message": "Username ".concat(req.params.username, " not found") })];
                }
                res.json({ "user": user });
                return [2 /*return*/];
        }
